local Translations = {
    ...
    menu = {
        ...
        ["give_money_menu"] = "Give Money",
        ["set_money_menu"] = "Set Money",
        ...
        ["maxammo"] = "Max Ammo",
        ["armour"] = "Add Armour",
        ["entity_view_desc"] = "Entity View Mode",
    ...
    desc = {
        ...
        ["give_money_menu_desc"] = "Give money to",
        ["set_money_menu_desc"] = "Set money of",
        ["remove_money_menu_desc"] = "Remove money from",
        ["item"] = "Which item to give",
        ["moneytype"] = "Select to add to cash or bank",
        ["moneytypeS"] = "Select to set cash or bank balance",
        ["moneytypeR"] = "Select to remove from cash or bank",
        ["amount"] = "Amount to give",
        ["setamount"] = "Amount to set",
        ...
        ["maxammo"] = "Give yourself max ammo",
